...
// --> General settings
$hesk_settings['site_title']='Galaxy ITT';
$hesk_settings['site_url']='http://localhost/helpdesk';
$hesk_settings['hesk_title']='Clients Help Desk';
$hesk_settings['hesk_url']='https://galaxyitt.com.ng/helpdesk';
$hesk_settings['webmaster_mail']='support@galaxyitt.com.ng';
...
$hesk_settings['secimg_sum']='3ZPGZVB4B5';
...
$hesk_settings['question_ask']='What is the next number after 5? (Use only digits to answer)';
...
$hesk_settings['url_key']='vYKZA76FN1uVFEbP99cycE_2gSE';
...
// --> Email sending
$hesk_settings['noreply_mail']='support@galaxyitt.com.ng';
$hesk_settings['noreply_name']='Galaxy ITT';
$hesk_settings['email_max_recipients']=50;
$hesk_settings['email_formatting']=3;
$hesk_settings['smtp']=0;
$hesk_settings['smtp_host_name']='mail.galaxyitt.com.ng';
...
$hesk_settings['imap_host_name']='mail.galaxyitt.com.ng';
...
$hesk_settings['pop3_host_name']='mail.galaxyitt.com.ng';
